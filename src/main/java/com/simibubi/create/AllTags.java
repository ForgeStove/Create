...
public class AllTags {
	...
	public enum AllBlockTags {
		...
		@SuppressWarnings("deprecation") public boolean matches(Block block) {
	...
	public enum AllItemTags {
		...
		@SuppressWarnings("deprecation") public boolean matches(Item item) {
	...
	public enum AllFluidTags {
		...
		FAN_PROCESSING_CATALYSTS_HAUNTING(MOD, "fan_processing_catalysts/haunting"),
		FAN_PROCESSING_CATALYSTS_SMOKING(MOD, "fan_processing_catalysts/smoking"),
		FAN_PROCESSING_CATALYSTS_SPLASHING(MOD, "fan_processing_catalysts/splashing"), HONEY(FORGE);
		...
		@SuppressWarnings("deprecation") public boolean matches(Fluid fluid) {
			return fluid.is(tag);
		}
