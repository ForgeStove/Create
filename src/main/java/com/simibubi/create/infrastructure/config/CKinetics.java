...
public class CKinetics extends ConfigBase {
	...
	public final ConfigInt maxDataSize = i(
			ContraptionData.DEFAULT_LIMIT,
			0,
			"maxDataSize",
			Comments.bytes,
			Comments.maxDataDisable,
			Comments.maxDataSize,
			Comments.maxDataSize2
	);
	...
	public final ConfigEnum<ContraptionMovementSetting>
			reinforcedDeepslateMovement
			= e(
			ContraptionMovementSetting.UNMOVABLE,
