...
public class CClient extends ConfigBase {
	...
	public final ConfigInt maxContraptionLightVolume = i(
			16384,
			0,
			Integer.MAX_VALUE,
	...
	private static class Comments {
		static String client =
				"Client-only settings - If you're looking for general settings, look inside your worlds serverconfig"
						+ " folder!";
		...
		static String maxContraptionLightVolume =
				"The maximum amount of blocks for which to try and calculate dynamic contraption lighting. Decrease "
						+ "if large contraption cause too much lag";
		...
		static String ignoreFabulousWarning =
				"Setting this to true will prevent Create from sending you a warning when playing with Fabulous "
						+ "graphics enabled";
		...
		static String overlayOffset =
				"Offset the overlay from goggle- and hover- information by this many pixels on the respective axis; "
						+ "Use /create overlay";
		...
		static String[] placementIndicator = new String[]{
				"What indicator should be used when showing where the assisted placement ends up relative to your "
						+ "crosshair", "Choose 'NONE' to disable the Indicator altogether"
		};
		...
		static String editingMode = "Show additional info in the ponder view and reload scene scripts more "
				+ "frequently.";
		...
		static String showTrackGraphOnF3 = "Display nodes and edges of a Railway Network while f3 debug mode is "
				+ "active";
		static String
				showExtendedTrackGraphOnF3
