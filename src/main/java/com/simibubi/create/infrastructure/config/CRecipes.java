...
public class CRecipes extends ConfigBase {
	...
	public final ConfigBool allowStonecuttingOnSaw = b(true, "allowStonecuttingOnSaw",
			Comments.allowStonecuttingOnSaw);
