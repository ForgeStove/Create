...
public class AllPlacedFeatures {
	public static final ResourceKey<PlacedFeature> ZINC_ORE = key("zinc_ore"), STRIATED_ORES_OVERWORLD = key(
			"striated_ores_overworld"), STRIATED_ORES_NETHER = key("striated_ores_nether");
	...
	public static void bootstrap(BootstapContext<PlacedFeature> ctx) {
		...
		register(ctx, STRIATED_ORES_NETHER, striatedOresNether, placement(RarityFilter.onAverageOnceEvery(18), 40,
				90));
	}
