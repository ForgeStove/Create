...
public class TrainScenes {
	public static void controls(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(initialControlsPos),
						Pointing.DOWN
				).rightClick(), 70
		);
		scene.idle(20);
	...
	public static void schedule(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(
				new InputWindowElement(target, Pointing.RIGHT).rightClick()
		...
		scene.idle(100);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(util.grid.at(3, 3, 4)), Pointing.DOWN).rightClick()
						.withItem(AllItems.SCHEDULE.asStack()), 80
		);
		scene.idle(6);
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.centerOf(util.grid.at(3, 1, 7)),
						Pointing.DOWN
		...
		scene.overlay.showControls(
				new InputWindowElement(target.add(0.5, 0, 0), Pointing.RIGHT).rightClick()
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(util.grid.at(3, 3, 4)),
						Pointing.DOWN
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(util.grid.at(6, 3, 4)),
						Pointing.DOWN
				).rightClick(), 70
		);
		scene.idle(6);
