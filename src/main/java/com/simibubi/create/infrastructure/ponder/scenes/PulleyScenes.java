...
public class PulleyScenes {
	public static void movement(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.centerOf(util.grid.at(2, 2, 0)),
						Pointing.RIGHT
	...
	public static void movementModes(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(pulleyPos), Pointing.DOWN).rightClick(),
				60
		);
	...
	public static void attachment(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<WorldSectionElement> poles = scene.world.showIndependentSection(
				util.select.fromTo(
						4,
						4,
						2,
		...
		ElementLink<WorldSectionElement> pulley = scene.world.showIndependentSection(
				util.select.position(pulleyPos),
				Direction.EAST
		);
		scene.idle(10);
