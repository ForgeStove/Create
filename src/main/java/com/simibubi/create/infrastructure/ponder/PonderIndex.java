...
public class PonderIndex {
	...
	public static void register() {
		...
		// Mechanical Piston
		HELPER.forComponents(AllBlocks.MECHANICAL_PISTON, AllBlocks.STICKY_MECHANICAL_PISTON).addStoryBoard(
				"mechanical_piston/anchor",
				PistonScenes::movement,
				AllPonderTags.KINETIC_APPLIANCES,
		...
		HELPER.forComponents(AllBlocks.MECHANICAL_HARVESTER).addStoryBoard("harvester",
				MovementActorScenes::harvester);
		...
		HELPER.forComponents(AllBlocks.PORTABLE_FLUID_INTERFACE).addStoryBoard(
		...
		// Trains
		HELPER.forComponents(TrackMaterial.allBlocks().stream().map((trackSupplier) -> new BlockEntry<TrackBlock>(
						...
						Create.REGISTRATE,
						RegistryObject.create(ForgeRegistries.BLOCKS.getKey(trackSupplier.get()),
		...
		if (REGISTER_DEBUG_SCENES) DebugScenes.registerAll();
	}
