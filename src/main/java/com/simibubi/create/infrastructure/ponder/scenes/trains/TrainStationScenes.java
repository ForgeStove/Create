...
public class TrainStationScenes {
	public static void assembly(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(20);
		scene.overlay.showControls(
				new InputWindowElement(marker, Pointing.DOWN).withItem(new ItemStack(Items.BARRIER)),
				60
		);
		scene.idle(6);
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(11, 0, 6), Pointing.RIGHT).rightClick()
						.withItem(casing), 80
		);
		scene.idle(6);
		scene.world.restoreBlocks(util.select.position(10, 2, 6));
		ElementLink<WorldSectionElement> trainElement1 = scene.world.showIndependentSection(
		...
		scene.idle(55);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(4, 0, 6), Pointing.RIGHT).rightClick()
						.withItem(casing), 15
		);
		scene.idle(6);
		scene.world.setBlock(util.grid.at(3, 2, 6), AllBlocks.SMALL_BOGEY.getDefaultState(), false);
		ElementLink<WorldSectionElement> trainElement2 = scene.world.showIndependentSection(
				util.select.position(
						3,
						2,
						6
		...
		scene.idle(20);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(7, 0, 6), Pointing.RIGHT).rightClick()
						.withItem(casing), 15
		);
		scene.idle(6);
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(util.grid.at(4, 2, 6)),
						Pointing.UP
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(util.grid.at(10, 2, 6)),
						Pointing.UP
				).withItem(AllItems.SUPER_GLUE.asStack()),
				40
		);
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(util.grid.at(5, 3, 5)),
						Pointing.DOWN
		...
		scene.idle(75);
		ElementLink<WorldSectionElement> controlsElement = scene.world.showIndependentSection(controls,
				Direction.DOWN);
		scene.idle(15);
		...
		scene.idle(85);
		scene.overlay.showControls(
				new InputWindowElement(stationTop, Pointing.DOWN).rightClick()
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(util.grid.at(6, 0, 2)),
						Pointing.DOWN
				).rightClick()
						.withWrench(), 15
		);
	...
	public static void autoSchedule(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(
				new InputWindowElement(
						target.add(0, 0.5, 0),
						Pointing.DOWN
				).withItem(AllItems.SCHEDULE.asStack()), 40
		);
		scene.idle(6);
