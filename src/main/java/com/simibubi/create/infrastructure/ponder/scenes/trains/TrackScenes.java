...
public class TrackScenes {
	public static void placement(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.showBasePlate();
		scene.idle(10);
		ElementLink<WorldSectionElement> bgTrack = scene.world.showIndependentSection(
				util.select.position(11, 4, 9),
				Direction.DOWN
		);
		...
		for (int i = 11; i >= 2; i--) {
			...
			if (i == 5) scene.world.showSectionAndMerge(util.select.position(7, 4, 9), Direction.DOWN, bgTrack);
			scene.idle(2);
		}
		...
		scene.idle(50);
		ElementLink<WorldSectionElement> fgTrack = scene.world.showIndependentSection(
				util.select.position(3, 3, 5),
				Direction.DOWN
		);
		...
		scene.overlay.showControls(
				new InputWindowElement(startTrack, Pointing.DOWN).rightClick().withItem(trackStack),
				40
		);
		scene.idle(6);
		...
		scene.idle(45);
		scene.overlay.showControls(
				new InputWindowElement(startTrack.add(9, 0, 0), Pointing.DOWN).rightClick()
		...
		scene.addKeyframe();
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(8, 0, 2), Pointing.DOWN).rightClick()
						.withItem(trackStack),
				15
		);
		scene.idle(15);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 0, 8), Pointing.DOWN).rightClick()
						.withItem(trackStack),
				15
		);
		scene.idle(7);
		...
		scene.idle(10);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(12, 0, 2), Pointing.DOWN).rightClick()
						.withItem(trackStack),
				10
		);
		scene.idle(15);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 0, 12), Pointing.DOWN).rightClick()
						.withItem(trackStack),
				10
		);
		scene.idle(7);
		...
		scene.idle(50);
		ElementLink<WorldSectionElement> longBend = scene.world.showIndependentSection(
				util.select.position(2, 2, 12),
				Direction.DOWN
		);
		...
		scene.idle(25);
		ElementLink<WorldSectionElement> slopeStart = scene.world.showIndependentSection(
				util.select.fromTo(
						12,
						6,
						2,
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.topOf(2, 4, 7),
						Pointing.LEFT
				).withItem(trackStack), 30
		);
		scene.idle(4);
		scene.overlay.showControls(
	...
	public static void portal(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(40);
		ElementLink<WorldSectionElement> t1 = scene.world.showIndependentSection(
				util.select.fromTo(5, 2, 1, 3, 3, 2),
				Direction.DOWN
		);
		ElementLink<WorldSectionElement> t2 = scene.world.showIndependentSection(
				util.select.fromTo(5, 2, 3, 3, 3, 3),
				Direction.DOWN
		);
		ElementLink<WorldSectionElement> t3 = scene.world.showIndependentSection(
				util.select.fromTo(5, 2, 4, 3, 3, 5),
				Direction.DOWN
		);
		ElementLink<ParrotElement> birb = scene.special.createBirb(
				util.vector.centerOf(4, 3, 2),
		...
		ElementLink<WorldSectionElement> nether = scene.world.showIndependentSection(
				util.select.layers(7, 1),
				Direction.UP
		);
		scene.world.moveSection(nether, util.vector.of(0, -7, 0), 0);
		scene.special.moveParrot(birb, util.vector.of(0, 0, -.1f), 1);
		scene.idle(25);
		ElementLink<WorldSectionElement> s1 = scene.world.showIndependentSection(
				util.select.fromTo(5, 2, 1, 3, 3, 5),
				null
		);
	...
	public static void chunks(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<WorldSectionElement> stationElement = scene.world.showIndependentSection(
				util.select.fromTo(
						0,
						0,
						0,
