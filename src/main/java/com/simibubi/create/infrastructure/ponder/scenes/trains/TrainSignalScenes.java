...
public class TrainSignalScenes {
	public static void placement(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(
				new InputWindowElement(marker, Pointing.DOWN).rightClick().withItem(AllBlocks.TRACK_SIGNAL.asStack()),
				40
		);
		scene.idle(6);
		...
		scene.idle(60);
		ElementLink<WorldSectionElement> signalElement = scene.world.showIndependentSection(fakeSignal,
				Direction.DOWN);
	...
	public static void signaling(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<ParrotElement> birb1 = scene.special.createBirb(
				util.vector.centerOf(18, 3, 7),
		...
		ElementLink<ParrotElement> birb2 = scene.special.createBirb(
				util.vector.centerOf(18, 3, 7),
				FacePointOfInterestPose::new
		);
		...
		scene.overlay.showControls(
				new InputWindowElement(
						util.vector.blockSurface(s1Pos, Direction.EAST),
						Pointing.RIGHT
				).rightClick()
						.withWrench(), 80
		);
		...
		birb1 = scene.special.createBirb(util.vector.centerOf(3, 3, 7).add(.5, 0, 0), DancePose::new);
		scene.idle(10);
		...
		ElementLink<ParrotElement> birb3 = scene.special.createBirb(
				util.vector.of(18, 3.5, -2),
				FacePointOfInterestPose::new
		);
	...
	public static void redstone(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(15);
		ElementLink<WorldSectionElement> comparatorElement = scene.world.showIndependentSection(
				comparator,
				Direction.SOUTH
		);
