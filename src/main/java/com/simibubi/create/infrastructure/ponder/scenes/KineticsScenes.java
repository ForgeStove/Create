...
public class KineticsScenes {
	...
	public static void shaftsCanBeEncased(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(3, 1, 2), Pointing.DOWN).rightClick()
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(1, 0, 2), Pointing.UP).rightClick().withItem(brassCasingItem),
				60
		);
		scene.idle(7);
	...
	public static void cogsSpeedUp(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<WorldSectionElement> cogs = scene.world.makeSectionIndependent(util.select.fromTo(
				lowerCog,
				upperCog
		));
	...
	public static void cogwheelsCanBeEncased(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ItemStack andesiteCasingItem = AllBlocks.ANDESITE_CASING.asStack();
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(3, 0, 2), Pointing.UP).rightClick()
						.withItem(andesiteCasingItem), 100
		);
		scene.idle(7);
		scene.world.setBlocks(
				util.select.position(3, 1, 2),
				andesiteEncased.getDefaultState()
		...
		scene.idle(15);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(2, 1, 2), Pointing.DOWN).rightClick()
						.withItem(andesiteCasingItem), 30
		);
		scene.idle(7);
		scene.world.setBlocks(
				small2,
				andesiteEncased.getDefaultState().setValue(EncasedCogwheelBlock.AXIS, Axis.Y),
				true
		);
		...
		ItemStack brassCasingItem = AllBlocks.BRASS_CASING.asStack();
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(1, 0, 3), Pointing.UP).rightClick().withItem(brassCasingItem),
				60
		);
		scene.idle(7);
		scene.world.setBlocks(
	...
	public static void waterWheel(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(80);
		scene.addKeyframe();
		ElementLink<WorldSectionElement> water = scene.world.makeSectionIndependent(util.select.fromTo(3, 1, 1, 3, 3
						, 1)
		...
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(wheel), Pointing.DOWN).rightClick()
						.withItem(crimsonPlanks),
				20
		);
		scene.idle(7);
		scene.world.modifyBlockEntity(wheel, WaterWheelBlockEntity.class,
	...
	public static void largeWaterWheel(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<WorldSectionElement> strip = scene.world.showIndependentSection(
				util.select.fromTo(
						1,
						0,
						0,
		...
		scene.idle(80);
		scene.addKeyframe();
		ElementLink<WorldSectionElement> water = scene.world.makeSectionIndependent(util.select.fromTo(3, 0, 0, 3, 3
						, 0)
		...
		ItemStack crimsonPlanks = new ItemStack(Items.CRIMSON_PLANKS);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(target), Pointing.DOWN).rightClick().withItem(crimsonPlanks),
				20
		);
		scene.idle(7);
		scene.world.modifyBlockEntity(wheel, WaterWheelBlockEntity.class,
		...
		ItemStack birchPlanks = new ItemStack(Items.BIRCH_PLANKS);
		scene.overlay.showControls(
				new InputWindowElement(util.vector.topOf(target), Pointing.DOWN).rightClick()
	...
	public static void valveHandle(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(3);
		ElementLink<WorldSectionElement> valve = scene.world.showIndependentSection(
				util.select.position(valvePos),
				Direction.SOUTH
		);
		...
		scene.addKeyframe();
		scene.overlay.showControls(
				new InputWindowElement(topOf, Pointing.DOWN).rightClick()
						.withItem(new ItemStack(Items.BLUE_DYE)), 40
		);
		scene.idle(7);
		scene.world.modifyBlock(
				valvePos,
				s -> AllBlocks.DYED_VALVE_HANDLES.get(DyeColor.BLUE)
						.getDefaultState()
	...
	public static void sequencedGearshift(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.world.cycleBlockProperty(util.grid.at(4, 1, 0), NixieTubeBlock.FACING);
		ElementLink<WorldSectionElement> comparator = scene.world.showIndependentSection(
				util.select.fromTo(
						5,
						1,
						1,
	...
	public static void speedController(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(10);
		ElementLink<WorldSectionElement> rsc = scene.world.showIndependentSection(
				util.select.position(0, 1, 1),
				Direction.DOWN
		);
		scene.world.moveSection(rsc, util.vector.of(1, 0, 0), 0);
		ElementLink<WorldSectionElement> rsc2 = scene.world.showIndependentSection(
	...
	private static void gauge(SceneBuilder scene, SceneBuildingUtil util, boolean speed) {
		...
		scene.world.setBlock(
				gaugePos,
				(speed ? AllBlocks.SPEEDOMETER : AllBlocks.STRESSOMETER).getDefaultState()
		...
		scene.overlay.showControls(
				new InputWindowElement(
						blockSurface,
						Pointing.RIGHT
				).withItem(AllItems.GOGGLES.asStack()), 80
		);
		scene.idle(7);
		scene.overlay.showText(80)
	...
	public static void creativeMotorMojang(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.world.showSection(
				util.select.fromTo(6, 3, 7, 9, 3, 7)
