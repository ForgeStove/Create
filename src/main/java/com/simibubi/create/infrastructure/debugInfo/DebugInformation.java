...
public class DebugInformation {
	...
	public static String getCpuInfo() {
		...
		return String.format("%s @ %s GHz; %s cores / %s threads on %s socket(s)", name, freq, cores, threads,
				sockets);
	}
	/**
	 ...
	 */
	@Nullable public static String getMcSystemInfo(String key) {
	...
	@Nullable public static String tryTrim(@Nullable String s) {
