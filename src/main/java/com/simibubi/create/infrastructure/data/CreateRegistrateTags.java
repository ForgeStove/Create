...
public class CreateRegistrateTags {
	...
	private static void genBlockTags(RegistrateTagsProvider<Block> provIn) {
		...
		prov.tag(AllBlockTags.TREE_ATTACHMENTS.tag).add(
				Blocks.BEE_NEST,
				Blocks.COCOA,
		...
		prov.tag(AllBlockTags.WRENCH_PICKUP.tag).add(
		...
		prov.tag(AllBlockTags.CORALS.tag).add(
		...
		// COMPAT
		TagGen.addOptional(
				prov.tag(AllBlockTags.NON_MOVABLE.tag), Mods.IE, List.of(
						"connector_lv",
						"connector_lv_relay",
						"connector_mv",
						"connector_mv_relay",
	...
	private static void genItemTags(RegistrateTagsProvider<Item> provIn) {
		...
		prov.tag(AllItemTags.UPRIGHT_ON_BELT.tag).add(
				Items.GLASS_BOTTLE,
				Items.POTION,
				Items.SPLASH_POTION,
		...
		prov.tag(AllItemTags.VANILLA_STRIPPED_LOGS.tag).add(
		...
		prov.tag(AllItemTags.VANILLA_STRIPPED_WOOD.tag).add(
		...
		TagGen.addOptional(
				prov.tag(AllItemTags.UA_CORAL.tag), Mods.UA, List.of(
						"acan_coral",
						"finger_coral",
						"star_coral",
						"moss_coral",
	...
	private record StrippedWoodHelper(TagAppender<Item> logAppender, TagAppender<Item> woodAppender) {
