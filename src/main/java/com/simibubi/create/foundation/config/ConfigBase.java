...
public abstract class ConfigBase {
	...
	public void onLoad() {
		if (children != null) children.forEach(ConfigBase::onLoad);
	}
	public void onReload() {
		if (children != null) children.forEach(ConfigBase::onReload);
	}
	public abstract String getName();
	@FunctionalInterface protected interface IValueProvider<V, T extends ConfigValue<V>>
	...
	protected <T extends ConfigBase> T nested(int depth, Supplier<T> constructor, String... comment) {
		...
		new CValue<Boolean, ForgeConfigSpec.BooleanValue>(
	...
	public class ConfigGroup extends CValue<Boolean, BooleanValue> {
		...
		@Override public void register(Builder builder) {
