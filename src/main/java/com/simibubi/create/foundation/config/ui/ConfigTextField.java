...
public class ConfigTextField extends HintableTextFieldWidget {
	...
	@Override public boolean mouseClicked(double x, double y, int button) {
		if (!isMouseOver(x, y)) setFocused(false);
		return super.mouseClicked(x, y, button);
	}
	@Override public void onClick(double pMouseX, double pMouseY) {
	...
	@Override public void setFocused(boolean focus) {
		...
		if (!focus) {
			if (ConfigScreenList.currentText == this) ConfigScreenList.currentText = null;
			return;
		}
