...
public class CreateAdvancement {
	...
	public boolean isAlreadyAwardedTo(Player player) {
		...
		Advancement advancement = sp.getServer().getAdvancements().getAdvancement(Create.asResource(id));
	...
	void save(Consumer<Advancement> t) {
		...
		datagenResult = builder.save(t, Create.asResource(id).toString());
	}
	...
	class Builder {
		...
		Builder whenItemCollected(TagKey<Item> tag) {
			return externalTrigger(InventoryChangeTrigger.TriggerInstance.hasItems(new ItemPredicate(
					tag,
					null,
