...
public final class ForcedDiffuseState {
	private static final ThreadLocal<ObjectArrayList<DiffuseLightCalculator>> FORCED_DIFFUSE = ThreadLocal.withInitial(
			ObjectArrayList::new);
	...
	@Nullable public static DiffuseLightCalculator getForcedCalculator() {
