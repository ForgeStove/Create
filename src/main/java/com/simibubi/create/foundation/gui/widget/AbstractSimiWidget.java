...
public abstract class AbstractSimiWidget extends AbstractWidget implements TickableGuiEventListener {
	...
	@Override protected ClientTooltipPositioner createTooltipPositioner() {
	...
	@Override public void updateWidgetNarration(NarrationElementOutput pNarrationElementOutput) {
