...
public class ScreenOpener {
	...
	private static boolean tryBackTracking(NavigatableSimiScreen screen) {
		...
		if (!(previouslyRenderedScreen instanceof NavigatableSimiScreen)) return false;
		if (!screen.isEquivalentTo((NavigatableSimiScreen) previouslyRenderedScreen)) return false;
	...
	@Nullable public static Screen getPreviouslyRenderedScreen() {
