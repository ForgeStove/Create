...
@OnlyIn(Dist.CLIENT) public abstract class AbstractSimiScreen extends Screen {
	...
	@Override public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
		...
		if (keyPressed || getFocused() instanceof EditBox) return keyPressed;
	...
	@Deprecated protected void debugWindowArea(GuiGraphics graphics) {
