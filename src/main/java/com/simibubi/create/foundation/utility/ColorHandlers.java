...
public class ColorHandlers {
	public static BlockColor getGrassyBlock() {
		return (state, world, pos, layer) -> pos != null && world != null ? BiomeColors.getAverageGrassColor(world,
				pos)
	...
	public static BlockColor getRedstonePower() {
		return (state, world, pos, layer) -> RedStoneWireBlock.getColorForPower(pos != null && world != null
