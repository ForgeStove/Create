...
public class AirParticleData implements ParticleOptions, ICustomParticleDataWithSprite<AirParticleData> {
	public static final Codec<AirParticleData>
			CODEC
	...
	public static final ParticleOptions.Deserializer<AirParticleData>
			DESERIALIZER
			= new ParticleOptions.Deserializer<>() {
		public AirParticleData fromCommand(ParticleType<AirParticleData> particleTypeIn, StringReader reader) throws
	...
	@Override public Deserializer<AirParticleData> getDeserializer() {
		return DESERIALIZER;
	}
	@Override public Codec<AirParticleData> getCodec(ParticleType<AirParticleData> type) {
		return CODEC;
	}
	@Override @OnlyIn(Dist.CLIENT) public SpriteParticleRegistration<AirParticleData> getMetaFactory() {
