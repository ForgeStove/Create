...
public class RotatedPillarCTBehaviour extends HorizontalCTBehaviour {
	...
	@Override protected boolean reverseUVs(BlockState state, Direction face) {
		...
		if (axis == Axis.X) return face.getAxisDirection() == AxisDirection.NEGATIVE && face.getAxis() != Axis.X;
		if (axis == Axis.Z) return face != Direction.NORTH && face.getAxisDirection() != AxisDirection.POSITIVE;
	...
	@Override public CTSpriteShiftEntry getShift(BlockState state, Direction direction, TextureAtlasSprite sprite) {
