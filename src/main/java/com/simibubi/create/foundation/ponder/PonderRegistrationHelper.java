...
public class PonderRegistrationHelper {
	...
	public PonderStoryBoardEntry addStoryBoard(
	...
	public PonderStoryBoardEntry createStoryBoardEntry(
			PonderStoryBoard storyBoard,
			ResourceLocation schematicLocation,
			ResourceLocation component
	) {
	...
	public class MultiSceneBuilder {
		...
		public MultiSceneBuilder addStoryBoard(
			...
			components.forEach(c -> extras.accept(PonderRegistrationHelper.this.addStoryBoard(
					c,
					schematicLocation,
					storyBoard
			)));
