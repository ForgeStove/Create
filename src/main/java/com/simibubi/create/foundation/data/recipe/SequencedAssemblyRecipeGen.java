...
public class SequencedAssemblyRecipeGen extends CreateRecipeProvider {
	GeneratedRecipe
			...
			//		)
			PRECISION_MECHANISM = create(
			"precision_mechanism",
			b -> b.require(I.goldSheet())
	...
	), REINFORCED_SHEET = create(
			"sturdy_sheet",
			b -> b.require(AllItemTags.OBSIDIAN_DUST.tag)
			...
			"track",
			b -> b.require(AllItemTags.SLEEPERS.tag)
	...
	protected GeneratedRecipe create(String name, UnaryOperator<SequencedAssemblyRecipeBuilder> transform) {
		GeneratedRecipe
				generatedRecipe
				= c -> transform.apply(new SequencedAssemblyRecipeBuilder(Create.asResource(name))).build(c);
