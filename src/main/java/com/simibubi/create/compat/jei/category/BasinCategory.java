...
@ParametersAreNonnullByDefault public class BasinCategory extends CreateRecipeCategory<BasinRecipe> {
	...
	@Override public void setRecipe(IRecipeLayoutBuilder builder, BasinRecipe recipe, IFocusGroup focuses) {
		List<Pair<Ingredient, MutableInt>>
	...
	public void draw(
		...
		graphics.drawString(
				...
				Lang.translateDirect(requiredHeat.getTranslationKey()),
				9,
				86,
