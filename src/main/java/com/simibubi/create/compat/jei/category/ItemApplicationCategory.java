...
@ParametersAreNonnullByDefault public class ItemApplicationCategory
	...
	@Override public void setRecipe(IRecipeLayoutBuilder builder, ItemApplicationRecipe recipe, IFocusGroup focuses) {
		...
		builder.addSlot(RecipeIngredientRole.INPUT, 51, 5)
				...
				.addTooltipCallback(recipe.shouldKeepHeldItem()
						? (view, tooltip) -> tooltip.add(1,
