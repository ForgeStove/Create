 ...
 */
@ParametersAreNonnullByDefault public class ConversionRecipe extends ProcessingRecipe<RecipeWrapper> {
	...
	public static ConversionRecipe create(ItemStack from, ItemStack to) {
		...
		return new ProcessingRecipeBuilder<>(ConversionRecipe::new, recipeId).withItemIngredients(Ingredient.of(from))
