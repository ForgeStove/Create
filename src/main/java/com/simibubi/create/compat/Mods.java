...
public enum Mods {
	...
	public boolean contains(ItemLike entry) {
		...
		return asItem != null && RegisteredObjects.getKeyOrThrow(asItem).getNamespace().equals(id);
	}
	/**
	 ...
	 * @return Optional.empty() if the mod is not loaded, otherwise an Optional of the return value of the given
	 * 		supplier
	 */
