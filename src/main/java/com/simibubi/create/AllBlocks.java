...
public class AllBlocks {
	...
	public static final BlockEntry<CogWheelBlock> LARGE_COGWHEEL = REGISTRATE.block(
			...
			.build()
			.register();
	public static final BlockEntry<EncasedShaftBlock>
	...
	public static final BlockEntry<EncasedShaftBlock> BRASS_ENCASED_SHAFT = REGISTRATE.block(
					"brass_encased_shaft",
					p -> new EncasedShaftBlock(p, AllBlocks.BRASS_CASING::get)
			)
			...
			.transform(axeOrPickaxe())
			.register();
	public static final BlockEntry<EncasedCogwheelBlock> ANDESITE_ENCASED_COGWHEEL = REGISTRATE.block(
					"andesite_encased_cogwheel",
					p -> new EncasedCogwheelBlock(p, false, AllBlocks.ANDESITE_CASING::get)
			)
			.properties(p -> p.mapColor(MapColor.PODZOL))
			...
			.transform(axeOrPickaxe())
			.register();
	public static final BlockEntry<EncasedCogwheelBlock> BRASS_ENCASED_COGWHEEL = REGISTRATE.block(
					"brass_encased_cogwheel",
					p -> new EncasedCogwheelBlock(p, false, AllBlocks.BRASS_CASING::get)
			)
			.properties(p -> p.mapColor(MapColor.TERRACOTTA_BROWN))
			...
			.transform(axeOrPickaxe())
			.register();
	public static final BlockEntry<EncasedCogwheelBlock> ANDESITE_ENCASED_LARGE_COGWHEEL = REGISTRATE.block(
			...
			.transform(axeOrPickaxe())
			.register();
	public static final BlockEntry<EncasedCogwheelBlock> BRASS_ENCASED_LARGE_COGWHEEL = REGISTRATE.block(
					"brass_encased_large_cogwheel",
					p -> new EncasedCogwheelBlock(p, true, AllBlocks.BRASS_CASING::get)
			)
			.properties(p -> p.mapColor(MapColor.TERRACOTTA_BROWN))
	...
	public static final BlockEntry<GearshiftBlock> GEARSHIFT = REGISTRATE.block("gearshift", GearshiftBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<ChainDriveBlock> ENCASED_CHAIN_DRIVE = REGISTRATE.block(
					"encased_chain_drive",
					ChainDriveBlock::new
			)
			.initialProperties(SharedProperties::stone)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<ChainGearshiftBlock> ADJUSTABLE_CHAIN_GEARSHIFT = REGISTRATE.block(
	...
	public static final BlockEntry<BeltBlock> BELT = REGISTRATE.block("belt", BeltBlock::new)
			...
			.register();
	public static final BlockEntry<CreativeMotorBlock> CREATIVE_MOTOR = REGISTRATE.block(
					"creative_motor",
	...
	public static final BlockEntry<WaterWheelBlock> WATER_WHEEL = REGISTRATE.block("water_wheel", WaterWheelBlock::new)
			...
			.transform(axeOrPickaxe())
			.blockstate((c, p) -> BlockStateGen.directionalBlockIgnoresWaterlogged(
					c,
					p,
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<LargeWaterWheelBlock> LARGE_WATER_WHEEL = REGISTRATE.block(
					"large_water_wheel",
			...
			.blockstate((c, p) -> axisBlock(
					c,
					p,
					s -> s.getValue(LargeWaterWheelBlock.EXTENSION)
							? AssetLookup.partialBaseModel(c, p, "extension")
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<WaterWheelStructuralBlock> WATER_WHEEL_STRUCTURAL = REGISTRATE.block(
	...
	public static final BlockEntry<HandCrankBlock> HAND_CRANK = REGISTRATE.block("hand_crank", HandCrankBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<CuckooClockBlock> CUCKOO_CLOCK = REGISTRATE.block(
					"cuckoo_clock",
			...
			.register();
	public static final BlockEntry<CuckooClockBlock> MYSTERIOUS_CUCKOO_CLOCK = REGISTRATE.block(
	...
	public static final BlockEntry<MillstoneBlock> MILLSTONE = REGISTRATE.block("millstone", MillstoneBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<CrushingWheelBlock> CRUSHING_WHEEL = REGISTRATE.block(
					"crushing_wheel",
	...
	public static final BlockEntry<CrushingWheelControllerBlock> CRUSHING_WHEEL_CONTROLLER = REGISTRATE.block(
			...
			.register();
	public static final BlockEntry<MechanicalPressBlock> MECHANICAL_PRESS = REGISTRATE.block(
					"mechanical_press",
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<MechanicalMixerBlock> MECHANICAL_MIXER = REGISTRATE.block(
					"mechanical_mixer",
	...
	public static final BlockEntry<BlazeBurnerBlock> BLAZE_BURNER = REGISTRATE.block(
			...
			.onRegister(block -> ItemBlockRenderTypes.setRenderLayer(block, RenderType.cutoutMipped()))
			.tag(
					AllBlockTags.FAN_PROCESSING_CATALYSTS_BLASTING.tag,
					AllBlockTags.FAN_PROCESSING_CATALYSTS_SMOKING.tag,
					AllBlockTags.FAN_TRANSPARENT.tag,
			...
			.build()
			.register();
	public static final BlockEntry<LitBlazeBurnerBlock> LIT_BLAZE_BURNER = REGISTRATE.block(
					"lit_blaze_burner",
			...
			.onRegister(block -> ItemBlockRenderTypes.setRenderLayer(block, RenderType.cutoutMipped()))
			.tag(
					AllBlockTags.FAN_PROCESSING_CATALYSTS_HAUNTING.tag,
					AllBlockTags.FAN_PROCESSING_CATALYSTS_SMOKING.tag,
					AllBlockTags.FAN_TRANSPARENT.tag,
					AllBlockTags.PASSIVE_BOILER_HEATERS.tag
			)
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(state -> ConfiguredModel.builder()
							.modelFile(p.models().getExistingFile(p.modLoc("block/blaze_burner/" + (
	...
	public static final BlockEntry<DepotBlock> DEPOT = REGISTRATE.block("depot", DepotBlock::new)
			...
			.transform(customItemModel("_", "block"))
			.register();
	public static final BlockEntry<EjectorBlock> WEIGHTED_EJECTOR = REGISTRATE.block(
					"weighted_ejector",
					EjectorBlock::new
			)
			.initialProperties(SharedProperties::stone)
	...
	public static final BlockEntry<FluidPipeBlock> FLUID_PIPE = REGISTRATE.block("fluid_pipe", FluidPipeBlock::new)
			.initialProperties(SharedProperties::copperMetal).properties(BlockBehaviour.Properties::forceSolidOn)
			.transform(pickaxeOnly())
	...
	public static final BlockEntry<GlassFluidPipeBlock> GLASS_FLUID_PIPE = REGISTRATE.block(
			...
			.transform(pickaxeOnly())
			.blockstate((c, p) -> {
				p.getVariantBuilder(c.getEntry()).forAllStatesExcept(
						state -> {
	...
	public static final BlockEntry<PumpBlock> MECHANICAL_PUMP = REGISTRATE.block("mechanical_pump", PumpBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<SmartFluidPipeBlock> SMART_FLUID_PIPE = REGISTRATE.block(
					"smart_fluid_pipe",
	...
	public static final BlockEntry<FluidValveBlock> FLUID_VALVE = REGISTRATE.block("fluid_valve", FluidValveBlock::new)
			.initialProperties(SharedProperties::copperMetal)
			.transform(pickaxeOnly())
			.blockstate((c, p) -> BlockStateGen.directionalAxisBlock(
					c, p, (state, vertical) -> AssetLookup.partialBaseModel(
							c,
							p,
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<ValveHandleBlock> COPPER_VALVE_HANDLE = REGISTRATE.block(
					"copper_valve_handle",
	...
	public static final BlockEntry<FluidTankBlock> FLUID_TANK = REGISTRATE.block("fluid_tank", FluidTankBlock::regular)
			...
			.build()
			.register();
	public static final BlockEntry<FluidTankBlock> CREATIVE_FLUID_TANK = REGISTRATE.block(
					"creative_fluid_tank",
	...
	public static final BlockEntry<SpoutBlock> SPOUT = REGISTRATE.block("spout", SpoutBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<PortableStorageInterfaceBlock> PORTABLE_FLUID_INTERFACE = REGISTRATE.block(
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<SteamEngineBlock> STEAM_ENGINE = REGISTRATE.block(
					"steam_engine",
	...
	public static final BlockEntry<WhistleBlock> STEAM_WHISTLE = REGISTRATE.block("steam_whistle", WhistleBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<WhistleExtenderBlock> STEAM_WHISTLE_EXTENSION = REGISTRATE.block(
			...
			.register();
	public static final BlockEntry<PoweredShaftBlock> POWERED_SHAFT = REGISTRATE.block(
					"powered_shaft",
			...
			.register();
	// Contraptions
	public static final BlockEntry<MechanicalPistonBlock> MECHANICAL_PISTON = REGISTRATE.block(
					"mechanical_piston",
			...
			.tag(AllBlockTags.SAFE_NBT.tag)
			.register();
	public static final BlockEntry<MechanicalPistonBlock> STICKY_MECHANICAL_PISTON = REGISTRATE.block(
			...
			.tag(AllBlockTags.SAFE_NBT.tag)
			.register();
	public static final BlockEntry<PistonExtensionPoleBlock> PISTON_EXTENSION_POLE = REGISTRATE.block(
			...
			.simpleItem()
			.register();
	public static final BlockEntry<MechanicalPistonHeadBlock> MECHANICAL_PISTON_HEAD = REGISTRATE.block(
			...
			.blockstate((c, p) -> BlockStateGen.directionalBlockIgnoresWaterlogged(
					...
					p,
					state -> p.models()
							.getExistingFile(p.modLoc("block/mechanical_piston/" + state.getValue(
	...
	public static final BlockEntry<WindmillBearingBlock> WINDMILL_BEARING = REGISTRATE.block(
			...
			.tag(AllBlockTags.SAFE_NBT.tag)
			.register();
	public static final BlockEntry<MechanicalBearingBlock> MECHANICAL_BEARING = REGISTRATE.block(
					"mechanical_bearing",
			...
			.register();
	public static final BlockEntry<ClockworkBearingBlock> CLOCKWORK_BEARING = REGISTRATE.block(
					"clockwork_bearing",
	...
	public static final BlockEntry<PulleyBlock.RopeBlock> ROPE = REGISTRATE.block("rope", PulleyBlock.RopeBlock::new)
			...
			.blockstate((c, p) -> p.simpleBlock(
					c.get(),
					p.models().getExistingFile(p.modLoc("block/rope_pulley/" + c.getName()))
			))
			.register();
	public static final BlockEntry<PulleyBlock.MagnetBlock> PULLEY_MAGNET = REGISTRATE.block(
					"pulley_magnet",
			...
			.register();
	public static final BlockEntry<ElevatorPulleyBlock> ELEVATOR_PULLEY = REGISTRATE.block(
					"elevator_pulley",
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<CartAssemblerBlock> CART_ASSEMBLER = REGISTRATE.block(
					"cart_assembler",
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<ControllerRailBlock> CONTROLLER_RAIL = REGISTRATE.block(
					"controller_rail",
			...
			.build()
			.register();
	public static final BlockEntry<MinecartAnchorBlock> MINECART_ANCHOR = REGISTRATE.block(
					"minecart_anchor",
			...
			.blockstate((c, p) -> p.simpleBlock(
					c.get(),
					p.models().getExistingFile(p.modLoc("block/cart_assembler/" + c.getName()))
			))
			.register();
	public static final BlockEntry<LinearChassisBlock> LINEAR_CHASSIS = REGISTRATE.block(
					"linear_chassis",
			...
			.simpleItem()
			.register();
	public static final BlockEntry<LinearChassisBlock> SECONDARY_LINEAR_CHASSIS = REGISTRATE.block(
			...
			.simpleItem()
			.register();
	public static final BlockEntry<RadialChassisBlock> RADIAL_CHASSIS = REGISTRATE.block(
					"radial_chassis",
	...
	public static final BlockEntry<StickerBlock> STICKER = REGISTRATE.block("sticker", StickerBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<ContraptionControlsBlock> CONTRAPTION_CONTROLS = REGISTRATE.block(
	...
	public static final BlockEntry<DeployerBlock> DEPLOYER = REGISTRATE.block("deployer", DeployerBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<PortableStorageInterfaceBlock> PORTABLE_STORAGE_INTERFACE = REGISTRATE.block(
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<RedstoneContactBlock> REDSTONE_CONTACT = REGISTRATE.block(
					"redstone_contact",
	...
	public static final BlockEntry<HarvesterBlock> MECHANICAL_HARVESTER = REGISTRATE.block(
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<PloughBlock> MECHANICAL_PLOUGH = REGISTRATE.block(
					"mechanical_plough",
					PloughBlock::new
			)
			.initialProperties(SharedProperties::stone)
	...
	public static final BlockEntry<SailBlock> SAIL_FRAME = REGISTRATE.block("sail_frame", SailBlock::frame)
			...
			.simpleItem()
			.register();
	public static final BlockEntry<SailBlock> SAIL = REGISTRATE.block(
					"white_sail",
					p -> SailBlock.withCanvas(p, DyeColor.WHITE)
			)
			.initialProperties(SharedProperties::wooden)
	...
	public static final BlockEntry<CasingBlock> SHADOW_STEEL_CASING = REGISTRATE.block(
			...
			.lang("Shadow Casing")
			.register();
	public static final BlockEntry<CasingBlock> REFINED_RADIANCE_CASING = REGISTRATE.block(
			...
			.lang("Radiant Casing")
			.register();
	public static final BlockEntry<MechanicalCrafterBlock> MECHANICAL_CRAFTER = REGISTRATE.block(
					"mechanical_crafter",
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<SequencedGearshiftBlock>
			SEQUENCED_GEARSHIFT
	...
	public static final BlockEntry<FlywheelBlock> FLYWHEEL = REGISTRATE.block("flywheel", FlywheelBlock::new)
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<SpeedControllerBlock> ROTATION_SPEED_CONTROLLER = REGISTRATE.block(
	...
	public static final BlockEntry<FakeTrackBlock> FAKE_TRACK = REGISTRATE.block("fake_track", FakeTrackBlock::new)
			...
			.blockstate((c, p) -> p.simpleBlock(
					c.get(),
					p.models().withExistingParent(c.getName(), p.mcLoc("block/air"))
			))
	...
	public static final BlockEntry<SignalBlock> TRACK_SIGNAL = REGISTRATE.block("track_signal", SignalBlock::new)
			...
			.blockstate((c, p) -> p.getVariantBuilder(c.get())
					.forAllStates(state -> ConfiguredModel.builder()
							.modelFile(AssetLookup.partialBaseModel(
									c,
									p,
									state.getValue(SignalBlock.TYPE).getSerializedName()
							))
							.build()))
			.lang("Train Signal")
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<TrackObserverBlock> TRACK_OBSERVER = REGISTRATE.block(
					"track_observer",
			...
			.transform(customItemModel("_", "block"))
			.register();
	public static final BlockEntry<StandardBogeyBlock> SMALL_BOGEY = REGISTRATE.block(
					"small_bogey",
					p -> new StandardBogeyBlock(p, BogeySizes.SMALL)
			)
			.properties(p -> p.mapColor(MapColor.PODZOL))
			.transform(BuilderTransformers.bogey())
			.register();
	public static final BlockEntry<StandardBogeyBlock> LARGE_BOGEY = REGISTRATE.block(
					"large_bogey",
					p -> new StandardBogeyBlock(p, BogeySizes.LARGE)
			)
			.properties(p -> p.mapColor(MapColor.PODZOL))
			.transform(BuilderTransformers.bogey())
			.register();
	public static final BlockEntry<ControlsBlock> TRAIN_CONTROLS = REGISTRATE.block("controls", ControlsBlock::new)
			...
			.blockstate((c, p) -> p.horizontalBlock(
					c.get(), s -> AssetLookup.partialBaseModel(
							c,
							p,
							s.getValue(ControlsBlock.VIRTUAL)
									? "virtual"
									: s.getValue(ControlsBlock.OPEN) ? "open" : "closed"
					)
			))
	...
	public static final BlockEntry<ItemVaultBlock> ITEM_VAULT = REGISTRATE.block("item_vault", ItemVaultBlock::new)
			...
			.build()
			.register();
	public static final BlockEntry<AndesiteFunnelBlock> ANDESITE_FUNNEL = REGISTRATE.block(
					"andesite_funnel",
			...
			.build()
			.register();
	public static final BlockEntry<BeltFunnelBlock> ANDESITE_BELT_FUNNEL = REGISTRATE.block(
					"andesite_belt_funnel",
					p -> new BeltFunnelBlock(AllBlocks.ANDESITE_FUNNEL, p)
			).onRegister(block -> ItemBlockRenderTypes.setRenderLayer(block, RenderType.cutoutMipped()))
			.initialProperties(SharedProperties::stone)
			.properties(p -> p.mapColor(MapColor.STONE))
			.transform(pickaxeOnly())
			...
			.register();
	public static final BlockEntry<BrassFunnelBlock> BRASS_FUNNEL = REGISTRATE.block(
					"brass_funnel",
			...
			.build()
			.register();
	public static final BlockEntry<BeltFunnelBlock> BRASS_BELT_FUNNEL = REGISTRATE.block(
					"brass_belt_funnel",
					p -> new BeltFunnelBlock(AllBlocks.BRASS_FUNNEL, p)
			).onRegister(block -> ItemBlockRenderTypes.setRenderLayer(block, RenderType.cutoutMipped()))
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.TERRACOTTA_YELLOW))
			.transform(pickaxeOnly())
			...
			.register();
	public static final BlockEntry<BeltTunnelBlock> ANDESITE_TUNNEL = REGISTRATE.block(
					"andesite_tunnel",
					BeltTunnelBlock::new
			)
			.properties(p -> p.mapColor(MapColor.STONE))
			...
			.register();
	public static final BlockEntry<BrassTunnelBlock> BRASS_TUNNEL = REGISTRATE.block(
					"brass_tunnel",
			...
			.register();
	public static final BlockEntry<SmartObserverBlock> SMART_OBSERVER = REGISTRATE.block(
					"content_observer",
			...
			.transform(customItemModel("_", "block"))
			.register();
	public static final BlockEntry<ThresholdSwitchBlock> THRESHOLD_SWITCH = REGISTRATE.block(
					"stockpile_switch",
			...
			.register();
	public static final BlockEntry<CreativeCrateBlock> CREATIVE_CRATE = REGISTRATE.block(
					"creative_crate",
			...
			.register();
	public static final BlockEntry<DisplayLinkBlock> DISPLAY_LINK = REGISTRATE.block(
					"display_link",
			...
			.transform(customItemModel("_", "block"))
			.register();
	public static final BlockEntry<FlapDisplayBlock> DISPLAY_BOARD = REGISTRATE.block(
					"display_board",
			...
			.transform(customItemModel())
			.register();
	public static final BlockEntry<NixieTubeBlock> ORANGE_NIXIE_TUBE = REGISTRATE.block(
					"nixie_tube",
					p -> new NixieTubeBlock(p, DyeColor.ORANGE)
			)
			.initialProperties(SharedProperties::softMetal)
	...
	public static final DyedBlockList<NixieTubeBlock> NIXIE_TUBES = new DyedBlockList<>(colour -> {
		if (colour == DyeColor.ORANGE) return ORANGE_NIXIE_TUBE;
		String colourName = colour.getSerializedName();
	...
	public static final BlockEntry<RoseQuartzLampBlock> ROSE_QUARTZ_LAMP = REGISTRATE.block(
					"rose_quartz_lamp",
			...
			.blockstate((c, p) -> BlockStateGen.simpleBlock(
					c, p, s -> {
			...
			.simpleItem()
			.register();
	public static final BlockEntry<RedstoneLinkBlock> REDSTONE_LINK = REGISTRATE.block(
					"redstone_link",
			...
			.register();
	public static final BlockEntry<AnalogLeverBlock> ANALOG_LEVER = REGISTRATE.block(
					"analog_lever",
	...
	public static final BlockEntry<PlacardBlock> PLACARD = REGISTRATE.block("placard", PlacardBlock::new)
			...
			.simpleItem()
			.register();
	public static final BlockEntry<BrassDiodeBlock> PULSE_REPEATER = REGISTRATE.block(
					"pulse_repeater",
					BrassDiodeBlock::new
			)
			...
			.build()
			.register();
	public static final BlockEntry<BrassDiodeBlock> PULSE_EXTENDER = REGISTRATE.block(
					"pulse_extender",
					BrassDiodeBlock::new
			)
			.initialProperties(() -> Blocks.REPEATER)
			...
			.build()
			.register();
	public static final BlockEntry<PoweredLatchBlock> POWERED_LATCH = REGISTRATE.block(
					"powered_latch",
			...
			.simpleItem()
			.register();
	public static final BlockEntry<ToggleLatchBlock> POWERED_TOGGLE_LATCH = REGISTRATE.block(
			...
			.register();
	public static final BlockEntry<LecternControllerBlock> LECTERN_CONTROLLER = REGISTRATE.block(
					"lectern_controller",
					LecternControllerBlock::new
			)
			.initialProperties(() -> Blocks.LECTERN)
			.transform(axeOnly())
			.blockstate((c, p) -> p.horizontalBlock(c.get(), p.models().getExistingFile(p.mcLoc("block/lectern"))))
			.loot((lt, block) -> lt.dropOther(block, Blocks.LECTERN))
			.register();
	// Curiosities
	public static final BlockEntry<BacktankBlock> COPPER_BACKTANK = REGISTRATE.block(
					"copper_backtank",
					BacktankBlock::new
			)
			.initialProperties(SharedProperties::copperMetal)
			...
			.register();
	public static final BlockEntry<BacktankBlock> NETHERITE_BACKTANK = REGISTRATE.block(
					"netherite_backtank",
					BacktankBlock::new
			)
			...
			.register();
	public static final BlockEntry<PeculiarBellBlock> PECULIAR_BELL = REGISTRATE.block(
					"peculiar_bell",
			...
			.register();
	public static final BlockEntry<HauntedBellBlock> HAUNTED_BELL = REGISTRATE.block(
					"haunted_bell",
	...
	public static final BlockEntry<ClipboardBlock> CLIPBOARD = REGISTRATE.block("clipboard", ClipboardBlock::new)
			.initialProperties(SharedProperties::wooden).properties(BlockBehaviour.Properties::forceSolidOn)
			.transform(axeOrPickaxe())
			.tag(AllBlockTags.SAFE_NBT.tag)
			.blockstate((c, p) -> p.horizontalFaceBlock(
					c.get(),
			...
			.onRegister(ClipboardBlockItem::registerModelOverrides).model(ClipboardOverrides::addOverrideModels)
			.build()
			.register();
	// Materials
	static {
	...
	public static final BlockEntry<MetalLadderBlock> ANDESITE_LADDER = REGISTRATE.block(
			...
			.register();
	public static final BlockEntry<MetalLadderBlock> BRASS_LADDER = REGISTRATE.block(
					"brass_ladder",
					MetalLadderBlock::new
			)
			.transform(BuilderTransformers.ladder(
			...
			.register();
	public static final BlockEntry<MetalLadderBlock> COPPER_LADDER = REGISTRATE.block(
					"copper_ladder",
					MetalLadderBlock::new
			)
			.transform(BuilderTransformers.ladder(
	...
	public static final BlockEntry<MetalScaffoldingBlock> ANDESITE_SCAFFOLD = REGISTRATE.block(
	...
	public static final BlockEntry<Block> COPYCAT_BASE = REGISTRATE.block("copycat_base", Block::new)
			...
			.blockstate((c, p) -> p.simpleBlock(c.get(), AssetLookup.partialBaseModel(c, p)))
			.register();
	public static final BlockEntry<CopycatStepBlock> COPYCAT_STEP = REGISTRATE.block(
					"copycat_step",
			...
			.recipe((c, p) -> p.stonecutting(
					DataIngredient.tag(AllTags.forgeItemTag("ingots/zinc")),
					RecipeCategory.BUILDING_BLOCKS, c,
					4
			))
			.transform(customItemModel("copycat_base", "step"))
			.register();
	public static final BlockEntry<CopycatPanelBlock> COPYCAT_PANEL = REGISTRATE.block(
					"copycat_panel",
			...
			.register();
	public static final BlockEntry<WrenchableDirectionalBlock> COPYCAT_BARS = REGISTRATE.block(
					"copycat_bars",
	...
	public static final BlockEntry<SlidingDoorBlock> ANDESITE_DOOR = REGISTRATE.block(
					"andesite_door",
					p -> SlidingDoorBlock.metal(p, true)
			)
			.transform(BuilderTransformers.slidingDoor("andesite"))
			.properties(p -> p.mapColor(MapColor.STONE).sound(SoundType.STONE).noOcclusion())
			.register();
	public static final BlockEntry<SlidingDoorBlock> BRASS_DOOR = REGISTRATE.block(
					"brass_door",
					p -> SlidingDoorBlock.metal(p, false)
			)
			.transform(BuilderTransformers.slidingDoor("brass"))
			.properties(p -> p.mapColor(MapColor.TERRACOTTA_YELLOW).sound(SoundType.STONE).noOcclusion())
			.register();
	public static final BlockEntry<SlidingDoorBlock> COPPER_DOOR = REGISTRATE.block(
					"copper_door",
					p -> SlidingDoorBlock.metal(p, true)
			)
			.transform(BuilderTransformers.slidingDoor("copper"))
			.properties(p -> p.mapColor(MapColor.COLOR_ORANGE).sound(SoundType.STONE).noOcclusion())
			.register();
	public static final BlockEntry<SlidingDoorBlock> TRAIN_DOOR = REGISTRATE.block(
					"train_door",
					p -> SlidingDoorBlock.metal(p, false)
			)
			.transform(BuilderTransformers.slidingDoor("train"))
			.properties(p -> p.mapColor(MapColor.TERRACOTTA_CYAN).sound(SoundType.NETHERITE_BLOCK).noOcclusion())
			.register();
	public static final BlockEntry<TrainTrapdoorBlock> TRAIN_TRAPDOOR = REGISTRATE.block(
					"train_trapdoor",
					TrainTrapdoorBlock::new
			)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.TERRACOTTA_CYAN).sound(SoundType.NETHERITE_BLOCK))
			.transform(BuilderTransformers.trapdoor(true))
			.register();
	public static final BlockEntry<SlidingDoorBlock> FRAMED_GLASS_DOOR = REGISTRATE.block(
					"framed_glass_door",
					p -> SlidingDoorBlock.glass(p, false)
			)
			.transform(BuilderTransformers.slidingDoor("glass"))
			.properties(p -> p.mapColor(MapColor.NONE).sound(SoundType.GLASS).noOcclusion())
			.register();
	public static final BlockEntry<TrainTrapdoorBlock> FRAMED_GLASS_TRAPDOOR = REGISTRATE.block(
	...
	public static final BlockEntry<Block> ZINC_ORE = REGISTRATE.block("zinc_ore", Block::new)
			...
			.transform(pickaxeOnly())
			.loot((lt, b) -> lt.add(
					b, RegistrateBlockLootTables.createSilkTouchDispatchTable(
							b, lt.applyExplosionDecay(
									b,
									LootItem.lootTableItem(AllItems.RAW_ZINC.get())
	...
	public static final BlockEntry<Block> INDUSTRIAL_IRON_BLOCK = REGISTRATE.block("industrial_iron_block", Block::new)
			...
			.transform(pickaxeOnly())
			.blockstate((c, p) -> p.simpleBlock(
					c.get(), p.models().cubeColumn(
							c.getName(),
							p.modLoc("block/industrial_iron_block"),
	...
	public static final BlockEntry<Block> BRASS_BLOCK = REGISTRATE.block("brass_block", Block::new)
			...
			.lang("Block of Brass")
			.register();
	public static final BlockEntry<ExperienceBlock> EXPERIENCE_BLOCK = REGISTRATE.block(
					"experience_block",
					ExperienceBlock::new
			)
			.initialProperties(SharedProperties::softMetal)
			.properties(p -> p.mapColor(MapColor.PLANT).sound(new ForgeSoundType(
					1,
					.5f,
			...
			.build()
			.register();
	public static final BlockEntry<RotatedPillarBlock> ROSE_QUARTZ_BLOCK = REGISTRATE.block(
					"rose_quartz_block",
			...
			.transform(pickaxeOnly())
			.blockstate((c, p) -> p.axisBlock(
					c.get(),
					p.modLoc("block/palettes/rose_quartz_side"),
					p.modLoc("block/palettes/rose_quartz_top")
			))
			.recipe((c, p) -> p.stonecutting(
					DataIngredient.items(AllItems.ROSE_QUARTZ.get()),
					RecipeCategory.BUILDING_BLOCKS, c,
					2
			))
			.simpleItem()
	...
	public static final CopperBlockSet COPPER_SHINGLES = new CopperBlockSet(
		...
		p.stonecutting(DataIngredient.tag(AllTags.forgeItemTag("ingots/copper")), RecipeCategory.BUILDING_BLOCKS, c,
				2);
	}
	);
	public static final CopperBlockSet COPPER_TILES = new CopperBlockSet(
			REGISTRATE, "copper_tiles", "copper_roof_top", CopperBlockSet.DEFAULT_VARIANTS, (c, p) -> {
		p.stonecutting(DataIngredient.tag(AllTags.forgeItemTag("ingots/copper")), RecipeCategory.BUILDING_BLOCKS, c,
				2);
	}
	);
