...
public class AllBogeyStyles {
	...
	public static final BogeyStyle STANDARD = create(
			"standard",
	...
	public static class BogeyStyleBuilder {
		...
		public BogeyStyleBuilder size(
				BogeySizes.BogeySize size,
				Supplier<Supplier<? extends BogeyRenderer>> renderer,
		...
		public BogeyStyleBuilder size(
			...
			DistExecutor.unsafeRunWhenOn(
					Dist.CLIENT, () -> () -> {
						this.sizeRenderers.put(
								size,
								() -> new BogeyStyle.SizeRenderData(renderer.get(), renderer.get().get())
						);
					}
			);
			return this;
