...
public class BlockBasedTrainConductorInteractionBehaviour extends MovingInteractionBehaviour {
	...
	public BlockBasedTrainConductorInteractionBehaviour(
			Predicate<BlockState> isValidConductor,
			TrainConductorHandler.UpdateScheduleCallback callback
	) {
	...
	public boolean handlePlayerInteraction(
		...
		if (info == null || !isValidConductor.test(info.state())) return false;
		...
		for (Direction direction : Iterate.directionsInAxis(assemblyDirection.getAxis())) {
			...
			if (train.runtime.getSchedule() != null) {
				...
				player.displayClientMessage(
						Lang.translateDirect(train.runtime.isAutoSchedule
								? "schedule.auto_removed_from_train"
								: "schedule.removed_from_train"), true
				);
