...
@EventBusSubscriber public class DivingBootsItem extends BaseArmorItem {
	...
	@SubscribeEvent public static void accellerateDescentUnderwater(LivingTickEvent event) {
