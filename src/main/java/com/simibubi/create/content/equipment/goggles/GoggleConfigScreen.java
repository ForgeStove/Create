...
public class GoggleConfigScreen extends AbstractSimiScreen {
	...
	public GoggleConfigScreen() {
		...
		tooltip.add(componentSpacing.plainCopy().append(Lang.translateDirect("gui.config.overlay1")));
		tooltip.add(componentSpacing.plainCopy()
				.append(Lang.translateDirect("gui.config.overlay2").withStyle(ChatFormatting.GRAY)));
		tooltip.add(Components.immutableEmpty());
		tooltip.add(componentSpacing.plainCopy().append(Lang.translateDirect("gui.config.overlay3")));
		tooltip.add(componentSpacing.plainCopy().append(Lang.translateDirect("gui.config.overlay4")));
		tooltip.add(Components.immutableEmpty());
		tooltip.add(componentSpacing.plainCopy()
				.append(Lang.translateDirect("gui.config.overlay5").withStyle(ChatFormatting.GRAY)));
		tooltip.add(componentSpacing.plainCopy()
				.append(Lang.translateDirect("gui.config.overlay6").withStyle(ChatFormatting.GRAY)));
		tooltip.add(Components.immutableEmpty());
		tooltip.add(componentSpacing.plainCopy().append(Lang.translateDirect("gui.config.overlay7")));
		tooltip.add(componentSpacing.plainCopy().append(Lang.translateDirect("gui.config.overlay8")));
	}
