...
public class PlaneMirror extends SymmetryMirror {
	...
	@Override public void applyModelTransform(PoseStack ms) {
		...
		TransformStack.cast(ms).centre().rotateY(orientation == Align.XY ? 0 : 90).unCentre();
	}
	@Override public List<Component> getAlignToolTips() {
		return ImmutableList.of(
				Lang.translateDirect("orientation.alongZ"),
				Lang.translateDirect("orientation" + ".alongX")
		);
	}
}
