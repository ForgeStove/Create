...
public class SpecialCopycatPanelBlockState extends SpecialBlockStateGen {
	...
	public <T extends Block> ModelFile getModel(
		...
		return facing(state).getAxis() == Axis.Y ? models.getExistingFile(prov.modLoc("block/copycat_panel/"
				+ name
				+ "_vertical")) : models.getExistingFile(prov.modLoc("block/copycat_panel/" + name));
	}
}
