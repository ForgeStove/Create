...
public class EjectorRenderer extends ShaftRenderer<EjectorBlockEntity> {
	...
	@Override public boolean shouldRenderOffScreen(EjectorBlockEntity p_188185_1_) {
		return true;
	}
	@Override
	...
	static <T extends Translate<T> & Rotate<T>> void applyLidAngle(
		...
		tr.centre()
				.rotateY(180 + AngleHelper.horizontalAngle(be.getBlockState().getValue(EjectorBlock.HORIZONTAL_FACING)))
				.unCentre()
