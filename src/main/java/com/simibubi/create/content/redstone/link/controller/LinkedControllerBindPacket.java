...
public class LinkedControllerBindPacket extends LinkedControllerPacketBase {
	...
	@Override protected void handleItem(ServerPlayer player, ItemStack heldItem) {
	...
	@Override protected void handleLectern(ServerPlayer player, LecternControllerBlockEntity lectern) {
	}
}
