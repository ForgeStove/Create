...
public abstract class LaunchedItem {
	...
	public static class ForBlockState extends LaunchedItem {
		...
		@Override void readNBT(CompoundTag nbt, HolderGetter<Block> holderGetter) {
		...
		@Override void place(Level world) {
	...
	public static class ForBelt extends ForBlockState {
		...
		@Override public CompoundTag serializeNBT() {
			...
			serializeNBT.putIntArray("Casing", Arrays.stream(casings).map(CasingType::ordinal).toList());
			return serializeNBT;
		}
		@Override void readNBT(CompoundTag nbt, HolderGetter<Block> holderGetter) {
	...
	public static class ForEntity extends LaunchedItem {
		...
		@Override public CompoundTag serializeNBT() {
			CompoundTag serializeNBT = super.serializeNBT();
			if (entity != null) serializeNBT.put("Entity", entity.serializeNBT());
			return serializeNBT;
		}
		@Override void readNBT(CompoundTag nbt, HolderGetter<Block> holderGetter) {
			super.readNBT(nbt, holderGetter);
