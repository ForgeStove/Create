...
public class ControlsHandler {
	...
	public static void startControlling(AbstractContraptionEntity entity, BlockPos controllerLocalPos) {
		...
		Minecraft.getInstance().player.displayClientMessage(
				Lang.translateDirect("contraption.controls.start_controlling",
	...
	public static void stopControlling() {
		...
		if (!currentlyPressed.isEmpty() && abstractContraptionEntity != null) AllPackets.getChannel()
				.sendToServer(new ControlsInputPacket(
						currentlyPressed,
						false,
		...
		levelUnloaded(null);
		Minecraft.getInstance().player.displayClientMessage(
				Lang.translateDirect("contraption.controls.stop_controlling"),
				true
		);
	}
	public static void tick() {
		...
		if (entity.isRemoved() || InputConstants.isKeyDown(
		...
		if (!newKeys.isEmpty()) {
			AllPackets.getChannel()
					.sendToServer(new ControlsInputPacket(newKeys, true, entity.getId(), controlsPos, false));
	...
	@Nullable public static AbstractContraptionEntity getContraption() {
		return entityRef.get();
	}
	@Nullable public static BlockPos getControlsPos() {
		return controlsPos;
	}
}
