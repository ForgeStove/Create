...
public class GantryCarriageRenderer extends KineticBlockEntityRenderer<GantryCarriageBlockEntity> {
	...
	@Override protected void renderSafe(
		...
		if (gantryAxis == Axis.Y) if (facing == Direction.NORTH || facing == Direction.EAST) angleForBE *= -1;
	...
	@Override protected BlockState getRenderedBlockState(GantryCarriageBlockEntity be) {
