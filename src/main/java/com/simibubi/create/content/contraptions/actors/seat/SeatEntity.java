...
public class SeatEntity extends Entity implements IEntityAdditionalSpawnData {
	...
	public static EntityType.Builder<?> build(EntityType.Builder<?> builder) {
		@SuppressWarnings("unchecked") EntityType.Builder<SeatEntity>
				entityBuilder
				= (EntityType.Builder<SeatEntity>) builder;
	...
	@Override protected void positionRider(Entity pEntity, Entity.MoveFunction pCallback) {
	...
	public static double getCustomEntitySeatOffset(Entity entity) {
		if (entity instanceof Slime) return 0.25f;
		...
		if (entity instanceof Frog) return 1 / 8f + 1 / 64f;
		return 0;
	}
	@Override public void setDeltaMovement(Vec3 p_213317_1_) {
	}
	...
	@Override public Vec3 getDismountLocationForPassenger(LivingEntity pLivingEntity) {
		return super.getDismountLocationForPassenger(pLivingEntity).add(0, 0.5f, 0);
	}
	@Override protected void defineSynchedData() {
	}
	@Override protected void readAdditionalSaveData(CompoundTag p_70037_1_) {
	}
	@Override protected void addAdditionalSaveData(CompoundTag p_213281_1_) {
	}
	...
	public static class Render extends EntityRenderer<SeatEntity> {
		...
		@Override public ResourceLocation getTextureLocation(SeatEntity p_110775_1_) {
			return null;
		}
	}
