...
public interface MovementBehaviour {
	...
	@Nullable default ItemStack canBeDisabledVia(MovementContext context) {
	...
	@OnlyIn(Dist.CLIENT) default void renderInContraption(
	...
	default ActorInstance createInstance(
