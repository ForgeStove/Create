...
public class OrientedContraptionEntityRenderer extends ContraptionEntityRenderer<OrientedContraptionEntity> {
	...
	@Override public boolean shouldRender(
		...
		if (!super.shouldRender(entity, p_225626_2_, p_225626_3_, p_225626_5_, p_225626_7_)) return false;
		return entity.getContraption().getType() != ContraptionType.MOUNTED || entity.getVehicle() != null;
	}
}
