...
public class TrackMaterialFactory {
	...
	private Ingredient railsIngredient = Ingredient.fromValues(Stream.of(
			new Ingredient.TagValue(AllTags.forgeItemTag(
					"nuggets/iron")),
	...
	@Nullable private TrackMaterial.TrackType.TrackBlockFactory customFactory = null;
	@OnlyIn(Dist.CLIENT) private TrackMaterial.TrackModelHolder modelHolder;
	@OnlyIn(Dist.CLIENT) private PartialModel tieModel;
	@OnlyIn(Dist.CLIENT) private PartialModel leftSegmentModel;
	@OnlyIn(Dist.CLIENT) private PartialModel rightSegmentModel;
		...
		DistExecutor.unsafeRunWhenOn(
				Dist.CLIENT, () -> () -> {
					...
					if (tieModel != null || leftSegmentModel != null || rightSegmentModel != null) {
						...
						modelHolder = new TrackMaterial.TrackModelHolder(tieModel, leftSegmentModel,
								rightSegmentModel);
					}
				}
		);
