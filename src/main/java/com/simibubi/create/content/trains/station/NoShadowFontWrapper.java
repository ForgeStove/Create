...
public class NoShadowFontWrapper extends Font {
	...
	@Override public int drawInBatch(
			Component pText,
			float pX,
			float pY,
			int pColor,
	...
	@Override public FormattedText ellipsize(FormattedText text, int maxWidth) {
		return wrapped.ellipsize(text, maxWidth);
	}
	@Override public int wordWrapHeight(FormattedText pText, int pMaxWidth) {
