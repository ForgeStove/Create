...
public abstract class AbstractStationScreen extends AbstractSimiScreen {
	...
	@Override protected void init() {
		if (blockEntity.computerBehaviour.hasAttachedComputer()) minecraft.setScreen(new ComputerScreen(
				title,
	...
	private void renderAdditional(
		...
		msr.pushPose()
				...
				.rotateX(-22)
				.rotateY(63);
		GuiGameElement.of(blockEntity.getBlockState().setValue(BlockStateProperties.WATERLOGGED, false))
				.render(graphics);
