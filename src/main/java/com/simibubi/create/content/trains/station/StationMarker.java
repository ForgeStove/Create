...
public class StationMarker {
	...
	public static class Decoration extends MapDecoration implements CustomRenderedMapDecoration {
		...
		@Override public boolean renderOnFrame() {
			return true;
		}
		@Override public void render(
			...
			buffer.vertex(mat, -1, -1, zOffset * index)
			...
			if (getName() != null) {
				...
				poseStack.pushPose();
				//				poseStack.translate((double)(0.0F + (float)getX() / 2.0F + 64.0F / 2.0F), (double)(0
				//				.0F + (float)getY() / 2.0F + 64.0F + 4.0F), (double)-0.025F);
		...
		@Override public boolean render(int index) {
			return true;
		}
	}
}
