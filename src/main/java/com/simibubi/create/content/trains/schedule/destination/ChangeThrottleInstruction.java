...
public class ChangeThrottleInstruction extends ScheduleInstruction {
	...
	@Override public List<Component> getSecondLineTooltip(int slot) {
		return ImmutableList.of(
				Lang.translateDirect("schedule.instruction.throttle_edit_box"),
				Lang.translateDirect("schedule.instruction.throttle_edit_box_1").withStyle(ChatFormatting.GRAY)
		);
	}
}
