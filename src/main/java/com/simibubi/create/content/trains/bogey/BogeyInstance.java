...
public final class BogeyInstance {
	...
	public void updateLight(BlockAndTintGetter world, CarriageContraptionEntity entity) {
		...
		commonRenderer.ifPresent(bogeyRenderer -> bogeyRenderer.updateLight(
				world.getBrightness(
						LightLayer.BLOCK,
						lightPos
