...
public class TrackMaterial {
	...
	public static final TrackMaterial ANDESITE = make(Create.asResource("andesite")).lang("Andesite")
	...
	@Nullable private final TrackMaterial.TrackType.TrackBlockFactory customFactory;
	@OnlyIn(Dist.CLIENT) protected TrackModelHolder modelHolder;
	@OnlyIn(Dist.CLIENT) public TrackModelHolder getModelHolder() {
		return modelHolder;
	}
	...
	public static class TrackType {
		@FunctionalInterface public interface TrackBlockFactory {
	...
	@OnlyIn(Dist.CLIENT) public record TrackModelHolder(
			PartialModel tie, PartialModel segment_left, PartialModel segment_right
	) {
