...
public class HandCrankInstance extends SingleRotatingInstance<HandCrankBlockEntity> implements DynamicInstance {
	...
	@Override public void init() {
		if (blockEntity.shouldRenderShaft()) super.init();
	}
	@Override public void remove() {
		if (blockEntity.shouldRenderShaft()) super.remove();
		if (crank != null) crank.delete();
	}
	@Override public void update() {
		if (blockEntity.shouldRenderShaft()) super.update();
	}
	@Override public void updateLight() {
		if (blockEntity.shouldRenderShaft()) super.updateLight();
