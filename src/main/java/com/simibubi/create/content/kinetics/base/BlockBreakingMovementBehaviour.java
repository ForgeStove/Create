...
public class BlockBreakingMovementBehaviour implements MovementBehaviour {
	...
	public void damageEntities(MovementContext context, BlockPos pos, Level world) {
		if (context.contraption.entity instanceof OrientedContraptionEntity oce && oce.nonDamageTicks > 0) return;
		...
		for (Entity entity : world.getEntitiesOfClass(Entity.class, new AABB(pos))) {
			...
			if (entity instanceof AbstractMinecart) for (Entity passenger : entity.getIndirectPassengers())
