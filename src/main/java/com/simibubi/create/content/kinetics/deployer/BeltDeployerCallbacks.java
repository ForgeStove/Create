...
public class BeltDeployerCallbacks {
	...
	public static ProcessingResult whenItemHeld(
		...
		if (recipe == null) return ProcessingResult.PASS;
	...
	public static void activate(
		...
		boolean unbreakable = heldItem.hasTag() && (
				heldItem.getTag().getBoolean("Unbreakable") || heldItem.getTag()
						.getString("Modifier")
						.equals("forbidden_arcanus:eternal")
		); // Forbidden Arcanus Compat, See Creators-of-Create#6220
		...
		if (recipe instanceof SandPaperPolishingRecipe) AllSoundEvents.SANDING_SHORT.playOnServer(world, pos, .35f,
				1f);
