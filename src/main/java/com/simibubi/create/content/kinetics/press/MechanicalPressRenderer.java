...
public class MechanicalPressRenderer extends KineticBlockEntityRenderer<MechanicalPressBlockEntity> {
	...
	@Override public boolean shouldRenderOffScreen(MechanicalPressBlockEntity be) {
		return true;
	}
	...
	@Override protected BlockState getRenderedBlockState(MechanicalPressBlockEntity be) {
