...
public class ShaftBlock extends AbstractSimpleShaftBlock implements EncasableBlock {
	...
	@MethodsReturnNonnullByDefault private static class PlacementHelper extends PoleHelper<Direction.Axis> {
		...
		public PlacementOffset getOffset(
			...
			if (offset.isSuccessful()) offset.withTransform(offset.getTransform()
