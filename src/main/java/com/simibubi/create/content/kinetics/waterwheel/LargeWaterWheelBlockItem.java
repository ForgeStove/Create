...
public class LargeWaterWheelBlockItem extends BlockItem {
	...
	@OnlyIn(Dist.CLIENT) public void showBounds(BlockPlaceContext context) {
		...
		CreateClient.OUTLINER.showAABB(
				...
				.colored(0xFF_ff5d6c);
		Lang.translate("large_water_wheel.not_enough_space").color(0xFF_ff5d6c).sendStatus(localPlayer);
	}
}
