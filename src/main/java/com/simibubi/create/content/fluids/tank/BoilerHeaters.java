...
public class BoilerHeaters {
	private static final AttachedRegistry<Block, Heater> BLOCK_HEATERS =
	...
	public static void registerDefaults() {
		registerHeater(
				AllBlocks.BLAZE_BURNER.get(), (level, pos, state) -> {
	...
	public interface HeaterProvider {
		@Nullable Heater getHeater(Level level, BlockPos pos, BlockState state);
	}
}
