...
public class FluidValveRenderer extends KineticBlockEntityRenderer<FluidValveBlockEntity> {
	...
	@Override protected void renderSafe(
		...
		if (pipeAxis.isHorizontal() && shaftAxis == Axis.X || pipeAxis.isVertical()) pointerRotationOffset = 90;
		pointer.centre()
	...
	@Override protected BlockState getRenderedBlockState(FluidValveBlockEntity be) {
